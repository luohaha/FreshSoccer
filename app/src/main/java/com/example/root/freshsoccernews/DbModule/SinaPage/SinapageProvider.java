 ...
 */
public class SinapageProvider extends ContentProvider {
    private String mTableName = "sinapage";
    private final String TAG = "sinapage";
    ...
    static {
        /**
         * want to use all record in table sinapage
         * if it match, and then return 1
         * */
        URI_MATCHER.addURI("com.example.root.freshsoccernews.DbModule.SinaPage.SinapageProvider",
                "sinapage", ALL_ID);
        /**
    ...
    public String getType(Uri uri) {
        ...
        switch (flag) {
            case ONE_ID :
                type = "vnd.android.cursor.item/sinapage";
                Log.i(TAG, "----->>getType return item");
                break;
            case ALL_ID :
                type = "vnd.android.cursor.dir/sinapages";
